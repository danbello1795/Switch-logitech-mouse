...
rem MX Keys S uses feature byte 0x0A. Try the receiver keyboard slots seen on this laptop.
...
.\hidapitester.exe --vidpid 046D:C548 --usage 0x0001 --usagePage 0xFF00 --open --length 7 --send-output 0x10,0x03,0x0A,0x1E,0x01,0x00,0x00
